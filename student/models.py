...
class Student(models.Model):
    ...
    """
    Pode ser uma relação one to one, que um estudante só pode ser criado
    se o tipo do vínculo for estudante, quando o vinculo for estudante é pra
    disparar um signal pra cria um estudante
    """
