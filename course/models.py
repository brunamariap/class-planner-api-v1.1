...
class ClassCanceled(models.Model):
    ...
    teacher_to_replace = models.ForeignKey(User, db_column='teacher_to_replace', blank=True, on_delete=models.DO_NOTHING, null=True)

class Teach(models.Model):
    class Meta:
        db_table = 'teach'

    teacher_id = models.ForeignKey(User, on_delete=models.CASCADE, db_column='teacher_id')
    discipline_id = models.ForeignKey(Discipline, on_delete=models.CASCADE, db_column='discipline_id')
    class_id = models.ForeignKey(Class, on_delete=models.CASCADE, db_column='class_id')
